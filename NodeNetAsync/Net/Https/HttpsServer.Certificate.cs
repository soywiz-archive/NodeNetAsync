...
namespace NodeNetAsync.Net.Https
{
	...
	{
		public static X509Certificate2 GetCertificateFromPEMstring(string PublicCertificateString, string PrivateKeyString, string Password)
		{
			return new X509Certificate2(
				GetBytesFromPEM(PublicCertificateString, PemStringType.Certificate),
				Password
			)
			{
				PrivateKey = DecodeRsaPrivateKey(GetBytesFromPEM(PrivateKeyString, PemStringType.RsaPrivateKey)),
			};
		}
